...
var format_AksesInternet_1 = new ol.format.GeoJSON();
var features_AksesInternet_1 = format_AksesInternet_1.readFeatures(json_AksesInternet_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AksesInternet_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AksesInternet_1.addFeatures(features_AksesInternet_1);
var lyr_AksesInternet_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AksesInternet_1, 
                style: style_AksesInternet_1,
                popuplayertitle: 'Akses Internet',
                interactive: true,
    title: 'Akses Internet<br />\
    <img src="styles/legend/AksesInternet_1_0.png" /> 1<br />\
    <img src="styles/legend/AksesInternet_1_1.png" /> 2<br />\
    <img src="styles/legend/AksesInternet_1_2.png" /> 3<br />\
    <img src="styles/legend/AksesInternet_1_3.png" /> 4<br />\
    <img src="styles/legend/AksesInternet_1_4.png" /> 5<br />' });
