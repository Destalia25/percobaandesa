var size = 0;
var placement = 'point';
function categories_AksesInternet_1(feature, value, size, resolution, labelText,
...
var style_AksesInternet_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Aks_Internet");
    ...
    var style = categories_AksesInternet_1(feature, value, size, resolution, labelText,
